    ...
    return (
        <main className="relative min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <Image
                ...
                priority
            />
            <div className="mb-10 ml-16 relative z-20 bg-black/50 backdrop-blur-sm p-4 rounded-xl w-fit border border-white/10">
            ...
            <div className="mb-10 ml-16 relative z-20 bg-black/50 backdrop-blur-sm p-4 rounded-xl w-fit border border-white/10">
                ...
                <br className="mt-2"/>
                <a href="/" className="text-2xl font-light uppercase px-4 py-2 rounded-md hover:underline hover:text-(--headerHover) hover:font-semibold">
                    Home
                </a>
            </div>
        </main>
